...
class L2_EXT_CLASS CADODatabase
{
public:
...
class L2_EXT_CLASS CADORecordset
{
public:
	...
	BOOL SetFieldValue(int nIndex, unsigned int nValue);
	BOOL SetFieldValue(LPCTSTR lpFieldName, unsigned int nValue);
	...
	BOOL GetFieldValue(int nIndex, unsigned int& nValue);
	BOOL GetFieldValue(LPCTSTR lpFieldName, unsigned int& nValue);
...
class L2_EXT_CLASS CADOParameter
{
public:
	...
	void SetPrecision(UCHAR nPrecision)
		{m_pParameter->PutPrecision(nPrecision);};
	void SetScale(UCHAR nScale)
...
class L2_EXT_CLASS CADOCommand
{
public:
...
class L2_EXT_CLASS CADOException : public CException
{
public:
