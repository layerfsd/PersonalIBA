...
void CIBAConfig::LoadConfig()
{
	...
	ReadValue(_T("IBA"), _T("AuditType"), m_nAuditType, 0);
	...
	ReadValue(_T("Duty"), _T("FixReserve"), m_strFixReserve, _T("0.00"));
	...
	// 2014-10-10 - qsc
	ReadValue(_T("IBA"), _T("ZdCrc"), SET(ZdCrc), 0);
}
...
void CIBAConfig::SaveConfig()
{
	...
	SaveValue(_T("Duty"), _T("FixReserve"), m_strFixReserve);
	...
	SaveValue(_T("IBA"), _T("ZdCrc"), GET(ZdCrc));	
}
