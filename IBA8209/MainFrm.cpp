...
BOOL CMainFrame::CreateOutPut()
{
	...
	// 隐藏座位视图
	//{
	//	if (!m_wndSeatStatusBar.Create(_T(""), this, CSize(150, 80),
	//		FALSE /* Has gripper */, 456,
	//		WS_CHILD | WS_VISIBLE | CBRS_TOP, CBRS_BCGP_REGULAR_TABS, CBRS_BCGP_RESIZE))
	//	{
	//		TRACE0("Failed to create statusBar bar\n");
	//		return FALSE;      // fail to create
	//	}

	//	// m_hOperationLog = m_wndOutput.GetSafeHwnd();

	//	m_wndSeatStatusBar.EnableDocking(CBRS_ALIGN_TOP);
