...
public:
	...
	static void ExePath( LPCTSTR strPath, LPCTSTR strParam = NULL);
	static CString GetUserOrgImagePath( int idType, const CString& zjh );
	static CString GetUserZJImagePath( int idType, const CString& zjh );
