...
class CRegisterDlg : public CNDDialog, public CG2XPrintHelper
{
...
private:
	...
	CBCGPComboBox m_comMemberClass;
...
public:
	...
	afx_msg void OnCbnSelchangeComboMemberclass();
	afx_msg void OnBnClickedBtnPhoto();
	afx_msg void OnBnClickedBtnRecapture();
};
